        ...
        <div style={{background: `linear-gradient(45deg, rgba(122,96,247,1) 0%, rgba(46,168,238,1) 100%)`}} className='w-1/2 pr-10 rounded-md shadow-md'>
          ...
          <form className='px-6 py-4' action='#' method='post'>
            ...
            <div className='mb-4'>
              ...
              <input style={{backgroundColor: `#ffffff96`}} type='text' id='services' name='services' className='mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm' />
            </div>
            <div className='mb-4'>
