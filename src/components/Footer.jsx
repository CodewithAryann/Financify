...
import { FaFacebookF, FaTwitter, FaLinkedinIn, FaInstagram, FaYoutube, FaTiktok } from "react-icons/fa6";
    ...
    <div className='footer w-full h-screen flex gap-10 p-10 pl-20 pr-16 font-["Montserrat"]'>
      ...
      <div className='flex gap-[2rem]'>
        ...
        <div>
          ...
          <a href="" className='social-icon bg-instagram move-down'><FaInstagram /></a>
            <a href="" className='social-icon bg-youtube move-down'><FaYoutube /></a>
            <a href="" className='social-icon bg-tiktok move-down'><FaTiktok /></a>
          </div>
        </div>
      </div>
    </div>
