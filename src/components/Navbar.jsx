...
function Navbar() {
  return (
    <div className='nav fixed z-[999] w-full pl-[3rem] pr-[3rem] py-[1.5rem] font-["Neue Montreal"] flex justify-between items-center text-white' style={{ backdropFilter: 'blur(3px)' }}>
      <div>
